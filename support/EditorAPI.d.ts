...
declare namespace Editor {
    ...
    * @beta
    */
    class IInstallableContentActions extends Editor.IPluginComponent {
...
declare namespace Editor {
    ...
    * @beta
    */
    class IInstallableContentRegistry extends Editor.IPluginComponent {
...
export declare enum ShaderGraphType {
    ShaderGraphImage = 0,
 ...
 */
export declare function getResourceFile(assetType: ShaderGraphType): Editor.Path;
/**
 ...
 */
export declare function findOrCreateNonNativeAsset(assetManager: Editor.Model.AssetManager, assetAbsPath: Editor.Path, destDirInProject: Editor.Path): Promise<Editor.Assets.Asset>;
/**
 ...
 */
export declare function findOrCreateNativeAsset(nativeAssetTypeName: string, assetManager: Editor.Model.AssetManager, basename: string, destinationDir?: Editor.Path): Editor.Assets.Asset;
/**
 ...
 */
export declare function findAsset(assetManager: Editor.Model.AssetManager, assetType: string, assetName: string, parentDir?: Editor.Path): Editor.Assets.Asset[];
/**
 ...
 */
export declare function findOrCreateObjectTrackingTexture(assetManager: Editor.Model.AssetManager, destination: Editor.Path, type: Editor.Assets.ObjectTrackingTextureType): Editor.Assets.Asset;
/**
 ...
 */
export declare function findOrCreateScreenTexture(assetManager: Editor.Model.AssetManager, destination: Editor.Path): Editor.Assets.Asset;
/**
 ...
 */
export declare function createMaterialFromGraph(assetManager: Editor.Model.AssetManager, graphType: ShaderGraphType, materialDir?: string, materialName?: string, shaderGraphDir?: string): Promise<{
 ...
 */
export declare function addGraphToMaterial(material: Editor.Assets.Material, pass: Editor.Assets.Pass, addDefineStrings?: string[]): Editor.Assets.PassInfo;
/**
 ...
 */
export declare function importImageAsTexture(assetManager: Editor.Model.AssetManager, imageFileAbsolutePath: string, wrapMode?: Editor.Assets.WrapMode, imageImportDestinationDir?: string): Promise<{
 ...
 */
export declare function addDefine(passInfo: Editor.Assets.PassInfo, define: string): void;
/**
 ...
 */
export declare function setupSamplerWrapMode(sampler: Editor.Assets.Sampler, wrapModeU: Editor.Assets.WrapMode, wrapModeV?: Editor.Assets.WrapMode, wrapModeW?: Editor.Assets.WrapMode): Editor.Assets.Sampler;
 ...
 */
export declare function promisify<T>(fn: (callback: (err: Error | null, result?: T) => void) => void): Promise<T>;
 ...
 */
export declare function findInAncestorsByType(base: Editor.Model.SceneObject, componentType: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 * @returns an array of found scene objects, or null if not found.
 */
export declare function findInDescendantsByType(base: Editor.Model.SceneObject | Editor.Assets.Scene, componentType: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 */
export declare function findInAncestorsByName(base: Editor.Model.SceneObject, name: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 * @returns an array of found scene objects, or null if not found.
 */
export declare function findInDescendantsByName(base: Editor.Model.SceneObject | Editor.Assets.Scene, name: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 * @returns an array of found scene objects, or null if not found.
 */
export declare function findInRootObjectsByType(scene: Editor.Assets.Scene, componentType: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 * @returns an array of found scene objects, or null if not found.
 */
export declare function findInRootObjectsByName(scene: Editor.Assets.Scene, name: string, options?: SearchOptions): Editor.Model.SceneObject[];
/**
 ...
 */
export declare function findOrCreateChildWithName(rootObject: Editor.Model.SceneObject, name: string, scene: Editor.Assets.Scene): Editor.Model.SceneObject;
/**
 ...
 */
export declare function findNearestCameraInAncestors(baseSceneObject: Editor.Model.SceneObject, cameraType?: Editor.Components.CameraType, maxDepth?: number): Editor.Model.SceneObject;
/**
 ...
 */
export declare function getNearestOrFirstCamera(sceneObject: Editor.Model.SceneObject, scene: Editor.Assets.Scene, cameraType?: Editor.Components.CameraType): Editor.Model.SceneObject;
/**
 ...
 */
export declare function getFirstCameraInScene(scene: Editor.Assets.Scene, cameraType?: Editor.Components.CameraType): Editor.Model.SceneObject;
/**
 ...
 */
export declare function getOrCreateCanvas(cameraObject: Editor.Model.SceneObject, unitType: Editor.Components.UnitType): Editor.Components.Canvas;
/**
 ...
 */
export declare function getOrCreateScreenRegion(cameraObject: Editor.Model.SceneObject, scene: Editor.Assets.Scene): Editor.Components.ScreenRegionComponent;
/**
 ...
 */
export declare function createOrthoCameraOnObject(scene: Editor.Assets.Scene, sceneObject: Editor.Model.SceneObject, unitType?: Editor.Components.UnitType, renderLayer?: Editor.Model.LayerId): Editor.Model.SceneObject;
/**
 ...
 */
export declare function createPerspectiveCameraOnObject(scene: Editor.Assets.Scene, sceneObject: Editor.Model.SceneObject, renderLayer?: Editor.Model.LayerId): Editor.Model.SceneObject;
/**
 ...
 */
export declare function findOrCreateOrthoCameraForObject(scene: Editor.Assets.Scene, sceneObject: Editor.Model.SceneObject, canvasUnitType?: Editor.Components.UnitType): {
 ...
 */
export declare function findOrCreateCameraObject(scene: Editor.Assets.Scene, cameraType: Editor.Components.CameraType, bearerSceneObject?: Editor.Model.SceneObject): Editor.Model.SceneObject;
 ...
 */
export declare function attachLCAHeader(request: Network.HttpRequest, issuer: string): void;
}
